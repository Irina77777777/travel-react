...
import sl20 from 'assets/sk22.jpg'
//@ts-ignore
import sl21 from 'assets/sk33.JPG'
        ...
        <div>
            ...
            >
                ...
                <Card component="li" sx={{ minWidth: 300, flexGrow: 1 }}>
                    <p>
                        Give thanks to the most high. You do know, you do know
                        that they don’t want you to have lunch. I’m keeping it
                        real with you, so what you going do is have lunch.
                        Another one. Egg whites, turkey sausage, wheat toast,
                        water. Of course they don’t want us to eat our
                        breakfast.
                    </p>
                </Card>
                    ...
                    <Card component="li" sx={{ minWidth: 500, flexGrow: 1 }}>
                        <CardCover>
                            ...
                            <p>
                                ...
                                cloth talk. I told you all this before, when you
                                have a swimming pool, do not use chlorine, use
                                salt water, the healing, salt water is the
                                healing. I’m up to something. Life is what you
                                make it, so let’s make it. The other day the
                                grass was brown, now it’s green because I ain’t
                ...
                <p>
                    ...
                    Another one. Learning is cool, but knowing is better, and I
                    know the key to success. The key to more success is to get a
                    massage once a week, very important, major key, cloth talk.
                    I told you all this before, when you have a swimming pool,
                    do not use chlorine, use salt water, the healing, salt water
                    is the healing. I’m up to something. Life is what you make
                    it, so let’s make it. The other day the grass was brown, now
                    it’s green because I ain’t give up. Never surrender.
                </p>
